...
class NewsPaperListCard extends Component {
    constructor(props) {
        super(props);
    }
                    ...
                    <Card cardStyle={{ height: 100, width: 160 }}>
                        <TouchableOpacity onPress={() => Actions.NewsList({ item: [rssUrl,imgUrl]})}>
                            <View style={{ height: 60, width: '100%', alignItems: 'center', justifyContent: 'center' }}>
                                ...
                                <TouchableOpacity style={{ height: 25, width: 30, position: 'absolute', right: -8, top: 7 }} onPress={()=> this.changeState(id)}>
                                    <Image style={{ height: 15, width: 15, tintColor: 'gray' }} source={this.changePic(id)} />
                                </TouchableOpacity>
                            </View>
                            <View style={{ borderBottomLeftRadius: 5, borderBottomRightRadius: 5, height: 40, width: 160, alignItems: 'center', justifyContent: 'center', backgroundColor: '#FAEBD7' }} >
...
export default connect(mapStateToProps, { changePosition, getNewsPaper, refreshList })(NewsPaperListCard);